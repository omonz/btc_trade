                ...
                <div class="col-md-10 text-right">
                    ...
                    <ul id="header-menu" class="header-navigation">
                        ...
                        <li><a href="#">Investment <i class="fa fa-caret-down"></i></a>
                            <ul class="mega-menu mega-menu1 mega-menu2 menu-postion">
                                <li class="mega-list mega-list1">
                                    <a href="{!! route('investment-new') !!}">New Investment </a>
                                    <a href="{!! route('investment-history') !!}">Investment History </a>
                                    <a href="{!! route('user-repeat-history') !!}">Repeat History </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li><a href="#">transaction <i class="fa fa-caret-down"></i></a>
                            <ul class="mega-menu mega-menu1 mega-menu2 menu-postion-2">
                                <li class="mega-list mega-list1">
                                    <a href="{!! route('withdraw-request') !!}">Withdraw Fund </a>
                                    <a href="{!! route('withdraw-log') !!}">Withdraw History </a>
                                    <a href="{!! route('deposit-fund') !!}">Deposit Fund </a>
                                    <a href="{!! route('deposit-history') !!}">Deposit History </a>
                                    <a href="{!! route('user-activity') !!}">Transaction Log </a>
                                </li>
                            </ul>
                        </li>

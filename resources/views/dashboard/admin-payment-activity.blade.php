                        ...
                        @foreach($log as $p)
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    ...
                                    <button type="button" class="btn btn-sm purple delete_button" value="{{ $p->id }}" data-toggle="modal" href="#small" balance="{{$p->amount}}" status="1" user_id="{{$p->user->id}}">Approve</button>

                                     <button type="button" class="btn btn-sm btn-danger delete_button" value="{{ $p->id }}" data-toggle="modal" href="#small" status="2">Cancel </button> </div>
                                    @else
